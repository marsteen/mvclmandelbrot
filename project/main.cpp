...
template <typename Tfloat>
void CalcMandelbrot(int mdim, int flimit, double x1, double y1, double x2, double y2)
{
...
int main(int argc, char** argv)
{
	...
	cout << "clmandelbrot version 1.2" << endl;
	cout << "uses AMD APP SDK 3.0" << endl;
	cout << "options: -double   = double precision" << endl;
	...
	if (prec == FPREC_FLOAT)
	{
		CalcMandelbrot<float>(mdim, flimit, x1, y1, x2, y2);
	}
	else
	{
		CalcMandelbrot<double>(mdim, flimit, x1, y1, x2, y2);
	}
